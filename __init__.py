        ...
        if armatureObject.type == 'ARMATURE':
            ...
            for targetBone in bpy.context.selected_pose_bones:
                ...
                if(targetBone.parent != None):
                    ...
                    bonePhysObject.rigid_body_constraint.spring_stiffness_x = 1000
                    bonePhysObject.rigid_body_constraint.spring_stiffness_y = 1000
                    bonePhysObject.rigid_body_constraint.spring_stiffness_z = 1000
                    bonePhysObject.rigid_body_constraint.spring_damping_x = 1
                    bonePhysObject.rigid_body_constraint.spring_damping_y = 1
                    bonePhysObject.rigid_body_constraint.spring_damping_z = 1
                ...
                physHandleObject.rigid_body_constraint.spring_stiffness_ang_x = 1000
                physHandleObject.rigid_body_constraint.spring_stiffness_ang_y = 1000
                physHandleObject.rigid_body_constraint.spring_stiffness_ang_z = 1000
                physHandleObject.rigid_body_constraint.spring_damping_ang_x = 1
                physHandleObject.rigid_body_constraint.spring_damping_ang_y = 1
                physHandleObject.rigid_body_constraint.spring_damping_ang_z = 1
